...
public class COMBO extends Heuristica {
    public COMBO(List<Map<Integer, Integer>> _orders, List<Map<Integer, Integer>> _aisles, int _nItems,
            int _waveSizeLB,
            int _waveSizeUB) {
    ...
    public void setUpHCplex() throws IloException {
        ...
        int minTopSize = Math.max(topSizes.get(0), 1); 
