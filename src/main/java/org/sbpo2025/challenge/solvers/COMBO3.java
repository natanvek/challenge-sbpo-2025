...
public class COMBO3 extends Heuristica {
    public COMBO3(List<Map<Integer, Integer>> _orders, List<Map<Integer, Integer>> _aisles, int _nItems,
            int _waveSizeLB,
            int _waveSizeUB) {
    ...
    List<Aisle> aislesVan;

    // pasar de Set<Order> a array fijo
    List<Order> ordersVan;
    ...
    public void setUpCplex() throws IloException {
        ...
        // // === INCREASE HEURISTIC FREQUENCY ===
        // cplex.setParam(IloCplex.Param.MIP.Strategy.HeuristicFreq, 5); // Lower = more
        // frequent
        ...
        // cplex.setParam(IloCplex.Param.MIP.Pool.Replace, 2); // Prefer diverse
        // solutions
