...
public class BothRanking_oldt extends Heuristica {
    public BothRanking_oldt(List<Map<Integer, Integer>> _orders, List<Map<Integer, Integer>> _aisles, int _nItems,
            int _waveSizeLB,
            int _waveSizeUB) {
    ...
    public ChallengeSolution solve(StopWatch stopWatch) {
        ...
        System.out.println("toy en oldt");
