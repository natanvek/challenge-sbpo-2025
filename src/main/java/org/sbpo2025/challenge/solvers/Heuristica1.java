...
public class Heuristica1 extends ChallengeSolver {
    public Heuristica1(List<Map<Integer, Integer>> orders, List<Map<Integer, Integer>> aisles, int nItems, int waveSizeLB, int waveSizeUB) {
        super(orders, aisles, nItems, waveSizeLB, waveSizeUB);
    }

    @Override
    public String getName() {
        return "Heuristica1";  // Nombre propio de la subclase
    }
